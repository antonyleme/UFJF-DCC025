 ...
 * @author anton
 */
public class PeopleVaccined extends javax.swing.JFrame {

    /**
     * Creates new form PeopleVaccined
     */
    public PeopleVaccined() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeopleVaccined.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PeopleVaccined().setVisible(true);
            }
        });
    }
